...
class r {
  constructor() {
    ...
    let e2 = 0;
    const s2 = () => {
      if (this.isAngieReady || e2 >= 500)
        return void (!this.isAngieReady && e2 >= 500 && this.handleDetectionTimeout());
...
!function(e2) {
  e2.assertEqual = (e3) => {
    ...
    const t2 = [];
    for (const s2 in e3)
      Object.prototype.hasOwnProperty.call(e3, s2) && t2.push(s2);
    return t2;
  }, e2.find = (e3, t2) => {
    for (const s2 of e3)
      if (t2(s2))
...
class u extends Error {
  ...
  format(e2) {
    const t2 = e2 || function(e3) {
      ...
      for (const r2 of e3.issues)
        if ("invalid_union" === r2.code)
          r2.unionErrors.map(a2);
        else if ("invalid_return_type" === r2.code)
          a2(r2.returnTypeError);
        else if ("invalid_arguments" === r2.code)
          a2(r2.argumentsError);
        else if (0 === r2.path.length)
          s2._errors.push(t2(r2));
        else {
          let e4 = s2, a3 = 0;
  ...
  flatten(e2 = (e3) => e3.message) {
    const t2 = {}, s2 = [];
    for (const a2 of this.issues)
      a2.path.length > 0 ? (t2[a2.path[0]] = t2[a2.path[0]] || [], t2[a2.path[0]].push(e2(a2))) : s2.push(e2(a2));
...
function p(e2, t2) {
  const s2 = h, a2 = ((e3) => {
    ...
    if (void 0 !== r2.message)
      return { ...r2, path: n2, message: r2.message };
    let o2 = "";
    const d2 = a3.filter((e4) => !!e4).slice().reverse();
    for (const e4 of d2)
      o2 = e4(i2, { data: t3, defaultError: o2 }).message;
...
class W extends A {
  _parse(e2) {
    ...
    for (const i2 of this._def.checks)
      if ("min" === i2.kind)
        e2.data.length < i2.value && (a2 = this._getOrReturnCtx(e2, a2), p(a2, { code: c.too_small, minimum: i2.value, type: "string", inclusive: true, exact: false, message: i2.message }), t2.dirty());
      else if ("max" === i2.kind)
        e2.data.length > i2.value && (a2 = this._getOrReturnCtx(e2, a2), p(a2, { code: c.too_big, maximum: i2.value, type: "string", inclusive: true, exact: false, message: i2.message }), t2.dirty());
      ...
      } else if ("email" === i2.kind)
        j.test(e2.data) || (a2 = this._getOrReturnCtx(e2, a2), p(a2, { validation: "email", code: c.invalid_string, message: i2.message }), t2.dirty());
      else if ("emoji" === i2.kind)
        P || (P = new RegExp("^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$", "u")), P.test(e2.data) || (a2 = this._getOrReturnCtx(e2, a2), p(a2, { validation: "emoji", code: c.invalid_string, message: i2.message }), t2.dirty());
      else if ("uuid" === i2.kind)
        O.test(e2.data) || (a2 = this._getOrReturnCtx(e2, a2), p(a2, { validation: "uuid", code: c.invalid_string, message: i2.message }), t2.dirty());
      else if ("nanoid" === i2.kind)
        I.test(e2.data) || (a2 = this._getOrReturnCtx(e2, a2), p(a2, { validation: "nanoid", code: c.invalid_string, message: i2.message }), t2.dirty());
      else if ("cuid" === i2.kind)
        C.test(e2.data) || (a2 = this._getOrReturnCtx(e2, a2), p(a2, { validation: "cuid", code: c.invalid_string, message: i2.message }), t2.dirty());
      else if ("cuid2" === i2.kind)
        R.test(e2.data) || (a2 = this._getOrReturnCtx(e2, a2), p(a2, { validation: "cuid2", code: c.invalid_string, message: i2.message }), t2.dirty());
      else if ("ulid" === i2.kind)
        Z.test(e2.data) || (a2 = this._getOrReturnCtx(e2, a2), p(a2, { validation: "ulid", code: c.invalid_string, message: i2.message }), t2.dirty());
      else if ("url" === i2.kind)
        try {
          new URL(e2.data);
        } catch {
  ...
  get minLength() {
    ...
    for (const t2 of this._def.checks)
      "min" === t2.kind && (null === e2 || t2.value > e2) && (e2 = t2.value);
    return e2;
  }
  get maxLength() {
    let e2 = null;
    for (const t2 of this._def.checks)
      "max" === t2.kind && (null === e2 || t2.value < e2) && (e2 = t2.value);
    return e2;
  }
}
function H(e2, t2) {
...
class G extends A {
  ...
  get isFinite() {
    ...
    for (const s2 of this._def.checks) {
      if ("finite" === s2.kind || "int" === s2.kind || "multipleOf" === s2.kind)
        return true;
...
class oe extends A {
  _parse(e2) {
    ...
    if (t2.parsedType !== o.array)
      return p(t2, { code: c.invalid_type, expected: o.array, received: t2.parsedType }), g;
...
class ce extends A {
  ...
  _parse(e2) {
    ...
    if (!(this._def.catchall instanceof ne && "strip" === this._def.unknownKeys))
      for (const e3 in s2.data)
        r2.includes(e3) || n2.push(e3);
    const i2 = [];
    for (const e3 of r2) {
    ...
    if (this._def.catchall instanceof ne) {
      ...
      if ("passthrough" === e3)
        for (const e4 of n2)
          i2.push({ key: { status: "valid", value: e4 }, value: { status: "valid", value: s2.data[e4] } });
      else if ("strict" === e3)
        n2.length > 0 && (p(s2, { code: c.unrecognized_keys, keys: n2 }), t2.dirty());
      else if ("strip" !== e3)
  ...
  pick(e2) {
    const t2 = {};
    for (const a2 of s.objectKeys(e2))
      e2[a2] && this.shape[a2] && (t2[a2] = this.shape[a2]);
    return new ce({ ...this._def, shape: () => t2 });
  }
  omit(e2) {
    const t2 = {};
    for (const a2 of s.objectKeys(this.shape))
      e2[a2] || (t2[a2] = this.shape[a2]);
    return new ce({ ...this._def, shape: () => t2 });
  }
  deepPartial() {
    return de(this);
...
class ue extends A {
  _parse(e2) {
    ...
    if (t2.common.async)
      return Promise.all(s2.map(async (e3) => {
        ...
        for (const t3 of e3)
          if ("valid" === t3.result.status)
            return t3.result;
        for (const s4 of e3)
          if ("dirty" === s4.result.status)
            return t2.common.issues.push(...s4.ctx.common.issues), s4.result;
...
class he extends A {
  _parse(e2) {
    ...
    if (t2.parsedType !== o.object)
      return p(t2, { code: c.invalid_type, expected: o.object, received: t2.parsedType }), g;
  ...
  static create(e2, t2, s2) {
    ...
    for (const s3 of t2) {
      ...
      for (const r2 of t3) {
        if (a2.has(r2))
          throw new Error(`Discriminator property ${String(e2)} has duplicate value ${String(r2)}`);
        a2.set(r2, s3);
      }
    }
...
class ge extends A {
  _parse(e2) {
    ...
    if (s2.parsedType !== o.array)
      return p(s2, { code: c.invalid_type, expected: o.array, received: s2.parsedType }), g;
    if (s2.data.length < this._def.items.length)
      return p(s2, { code: c.too_small, minimum: this._def.items.length, inclusive: true, exact: false, type: "array" }), g;
...
class fe extends A {
  ...
  _parse(e2) {
    const { status: t2, ctx: s2 } = this._processInputParams(e2);
    if (s2.parsedType !== o.object)
      return p(s2, { code: c.invalid_type, expected: o.object, received: s2.parsedType }), g;
    const a2 = [], r2 = this._def.keyType, n2 = this._def.valueType;
    for (const e3 in s2.data)
      a2.push({ key: r2._parse(new w(s2, e3, s2.path, e3)), value: n2._parse(new w(s2, s2.data[e3], s2.path, e3)), alwaysSet: e3 in s2.data });
...
class ye extends A {
  ...
  _parse(e2) {
    const { status: t2, ctx: s2 } = this._processInputParams(e2);
    if (s2.parsedType !== o.map)
      return p(s2, { code: c.invalid_type, expected: o.map, received: s2.parsedType }), g;
    ...
    if (s2.common.async) {
      ...
      return Promise.resolve().then(async () => {
        for (const s3 of n2) {
          ...
          if ("aborted" === a3.status || "aborted" === r3.status)
            return g;
...
class _e extends A {
  _parse(e2) {
    const { status: t2, ctx: s2 } = this._processInputParams(e2);
    if (s2.parsedType !== o.set)
      return p(s2, { code: c.invalid_type, expected: o.set, received: s2.parsedType }), g;
    const a2 = this._def;
...
class Se extends A {
  ...
  _parse(e2) {
    const { ctx: t2 } = this._processInputParams(e2);
    if (t2.parsedType !== o.promise && false === t2.common.async)
      return p(t2, { code: c.invalid_type, expected: o.promise, received: t2.parsedType }), g;
...
class Te extends A {
  ...
  _parse(e2) {
    ...
    if (n2.addIssue = n2.addIssue.bind(n2), "preprocess" === r2.type) {
      ...
      if (a2.common.async)
        return Promise.resolve(e3).then(async (e4) => {
          if ("aborted" === t2.value)
            return g;
...
var je;
Ne.create = (e2, t2) => new Ne({ innerType: e2, typeName: je.ZodReadonly, ...T(t2) }), ce.lazycreate, function(e2) {
...
const Pe = W.create, $e = G.create, Me = (Oe.create, J.create, Y.create), De = (X.create, ee.create, te.create, se.create, ae.create, re.create), Fe = (ne.create, ie.create, oe.create), qe = ce.create, ze = (ce.strictCreate, ue.create), Le = he.create, Ve = (me.create, ge.create, fe.create), Ue = (ye.create, _e.create, ve.create, xe.create), Ke = be.create, Qe = (we.create, Se.create, Te.create, Ae.create), Be = (Ce.create, Te.createWithPreprocess, "2.0"), We = ze([Pe(), $e().int()]), He = Pe(), Ge = qe({ progressToken: Qe(We) }).passthrough(), Je = qe({ _meta: Qe(Ge) }).passthrough(), Ye = qe({ method: Pe(), params: Qe(Je) }), Xe = qe({ _meta: Qe(qe({}).passthrough()) }).passthrough(), et = qe({ method: Pe(), params: Qe(Xe) }), tt = qe({ _meta: Qe(qe({}).passthrough()) }).passthrough(), st = ze([Pe(), $e().int()]), at = qe({ jsonrpc: Ue(Be), id: st }).merge(Ye).strict(), rt = qe({ jsonrpc: Ue(Be) }).merge(et).strict(), nt = qe({ jsonrpc: Ue(Be), id: st, result: tt }).strict();
var it;
!function(e2) {
...
class ws {
  ...
  async registerServer(e2) {
    ...
    if (this.angieDetector.isReady())
      ...
      console.log(`AngieMcpSdk: Server "${e2.name}" queued until Angie is ready`);
  }
  getRegistrations() {
  ...
  handleServerInitRequest(e2) {
    ...
    if (t2 && s2) {
      ...
      try {
        ...
        if (!t3)
          return void console.error(`AngieMcpSdk: No registration found for serverId: ${s2}`);
        const a2 = e2.ports[0];
        if (!a2)
          return void console.error("AngieMcpSdk: No port provided in server init request");
...
function mergeValues(a2, b2) {
  ...
  if (a2 === b2) {
    ...
    const sharedKeys = util$6.objectKeys(a2).filter((key) => bKeys.indexOf(key) !== -1);
    const newObj = { ...a2, ...b2 };
...
var validate$1 = function generate_validate(it2, $keyword, $ruleType) {
  var out = "";
  ...
  if (it2.isTop) {
    ...
    if ($id2)
      it2.baseId = it2.resolve.url(it2.baseId, $id2);
    if ($async && !it2.async)
...
function compIndex(schema, root, baseId) {
  for (var i2 = 0; i2 < this._compilations.length; i2++) {
    ...
    if (c2.schema == schema && c2.root == root && c2.baseId == baseId)
      return i2;
  }
  return -1;
}
function patternCode(i2, patterns) {
  return "var pattern" + i2 + " = new RegExp(" + util$2.toQuotedString(patterns[i2]) + ");";
}
...
var ref = function generate_ref(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var allOf = function generate_allOf(it2, $keyword, $ruleType) {
  var out = " ";
  var $schema2 = it2.schema[$keyword];
  var $schemaPath = it2.schemaPath + it2.util.getProperty($keyword);
  var $errSchemaPath = it2.errSchemaPath + "/" + $keyword;
...
var anyOf = function generate_anyOf(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var comment = function generate_comment(it2, $keyword, $ruleType) {
  var out = " ";
  var $schema2 = it2.schema[$keyword];
  var $errSchemaPath = it2.errSchemaPath + "/" + $keyword;
  !it2.opts.allErrors;
...
var _const = function generate_const(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var contains = function generate_contains(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var dependencies = function generate_dependencies(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var _enum = function generate_enum(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var format = function generate_format(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var _if = function generate_if(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var items = function generate_items(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var _limit = function generate__limit(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var _limitItems = function generate__limitItems(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var _limitLength = function generate__limitLength(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var _limitProperties = function generate__limitProperties(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var multipleOf = function generate_multipleOf(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var not = function generate_not(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var oneOf = function generate_oneOf(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var pattern = function generate_pattern(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var properties$2 = function generate_properties(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var propertyNames = function generate_propertyNames(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var required$1 = function generate_required(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
var uniqueItems = function generate_uniqueItems(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
function compileAsync(schema, meta, callback) {
  ...
  function _compileAsync(schemaObj) {
    ...
    function loadMissingSchema(e2) {
      ...
      if (added(ref2))
        throw new Error("Schema " + ref2 + " is loaded but " + e2.missingRef + " cannot be resolved");
...
var custom = function generate_custom(it2, $keyword, $ruleType) {
  var out = " ";
  var $lvl = it2.level;
  var $dataLvl = it2.dataLevel;
  var $schema2 = it2.schema[$keyword];
...
function removeKeyword(keyword2) {
  ...
  for (var i2 = 0; i2 < RULES.length; i2++) {
    var rules3 = RULES[i2].rules;
    for (var j2 = 0; j2 < rules3.length; j2++) {
      if (rules3[j2].keyword == keyword2) {
        rules3.splice(j2, 1);
        break;
      }
    }
...
async function registerAbilities(server) {
  ...
  abilities.forEach((ability) => {
    ...
    server.tool(
      ...
      input_schema,
      async (args) => {
        const response = await makeApiRequest(rest_path + ability.id + "/", args);
        return {
          content: [
            {
              type: "text",
...
function jsonSchemaToZod(jsonSchema) {
  const result = {};
  if (jsonSchema && jsonSchema.type === "object" && jsonSchema.properties && typeof jsonSchema.properties === "object") {
...
const init = async () => {
  try {
    ...
    await sdk.registerServer({
      name: "angie-ws-form-server",
      version: "1.0.0",
      description: "WS Form MCP Server for Angie AI assistant",
      server
    });

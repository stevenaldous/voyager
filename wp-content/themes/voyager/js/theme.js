...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.scout = {}));
	...
	* https://modernizr.com/download/?-objectfit-setclasses !*/
	!function (e, n, t) {
	  ...
	  function u(e, n, t) {
	    var r;
	    for (var i in e) if (e[i] in n) return t === false ? e[i] : (r = n[e[i]], o(r, "function") ? f(r, t || n) : r);
	    return false;
	  }
	  function p(e) {
	  ...
	  function c(n, t, r) {
	    ...
	    if ("getComputedStyle" in e) {
	      ...
	      var i = e.console;
	      if (null !== o) (o = o.getPropertyValue(r));else if (i) {
	        var s = i.error ? "error" : "log";
	        i[s].call(i, "getComputedStyle returning null, its possible modernizr test results are inaccurate");
	      }
	    } else o = n.currentStyle && n.currentStyle[r];
	    return o;
	  }
	  function d() {
	    var e = n.body;
	    return e || (e = l(w ? "svg" : "body"), e.fake = true), e;
	  }
	  function m(e, t, r, o) {
	    var i,
	      s,
	      ...
	      p = l("div"),
	      c = d();
	    if (parseInt(r, 10)) for (; r--;) a = l("div"), a.id = u + (r + 1), p.appendChild(a);
	  ...
	  function v(n, r) {
	    ...
	    if ("CSS" in e && "supports" in e.CSS) {
	      for (; o--;) if (e.CSS.supports(p(n[o]), r)) return true;
	      return false;
	    }
	  ...
	  function y(e, n, r, i) {
	    ...
	    if (i = o(i, "undefined") ? false : i, !o(r, "undefined")) {
	      var u = v(e, r);
	      if (!o(u, "undefined")) return u;
	    }
	    for (var p, c, d, m, y, g = ["modernizr", "tspan", "samp"]; !P.style && g.length;) p = true, P.modElem = l(g.shift()), P.style = P.modElem.style;
	    for (d = e.length, c = 0; d > c; c++) if (m = e[c], y = P.style[m], a(m, "-") && (m = s(m)), P.style[m] !== t) {
	      if (i || o(r, "undefined")) return f(), "pfx" == n ? m : true;
	      try {
	        P.style[m] = r;
	      } catch (h) {}
	      if (P.style[m] != y) return f(), "pfx" == n ? m : true;
	    }
	    return f(), false;
	  }
	  function g(e, n, t, r, i) {
	    ...
	    return o(n, "string") || o(n, "undefined") ? y(a, n, r, i) : (a = (e + " " + j.join(s + " ") + s).split(" "), u(a, n, t));
	  }
	  var h = [],
	    C = [],
	    S = {
	  ...
	  Modernizr.addTest("objectfit", !!N("objectFit"), {
	    aliases: ["object-fit"]
	  }), i(), r(h), delete S.addTest, delete S.addAsyncTest;
	...
	jQuery(document).ready(function ($) {
	  ...
	  .not('[href="#"]').not('[href="#0"]').not('a.noscroll').click(function (event) {
	    //On-page links
	...
	jQuery(document).ready(function ($) {
	  ...
	  - From: https://codepen.io/sandrina-p/pen/YzyOYRr
	  */
	  ...
	  if (elSelectNative) {
	    ...
	    var updateCustomSelectChecked = function updateCustomSelectChecked(value, text) {
	      ...
	      var elPrevOption = elSelectCustomOpts.querySelector("[data-value=\"" + prevValue + "\"");
	    ...
	    var supportKeyboardNavigation = function supportKeyboardNavigation(e) {
	      // press down -> go next
	    ...
	    var elSelectCustomOpts = elSelectCustom.children[1].children[0];
	    ...
	    elSelectNative.addEventListener("change", function (e) {
	      ...
	      var elRespectiveCustomOption = elSelectCustomOpts.querySelectorAll("[data-value=\"" + value + "\"]")[0];
	  ...
	  //////////////////////////////////////////////
	  // Recreate options for hover select in date archive
	  //////////////////////////////////////////////
	  $('#select-dates > option:not([disabled])').each(function () {
	    var val = $(this).attr('value');
	    var name = $(this).text();
	    var jsOpt = '<div class="selectCustom-option" data-value="' + val + '">' + name + '</div>';
	    $(this).parent('#select-dates').next('.selectCustom').find('#date-opt').append(jsOpt);
	  });

	  //////////////////////////////////////////////
	  // additional select code
	  //////////////////////////////////////////////

	  // custom Select blog filter page fire
	  $('.selectCustom-option').on('click', function () {

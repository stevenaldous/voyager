...
if ( ! function_exists( 'voyager_pagination' ) ) {
	/**
	 ...
	 */
	function voyager_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => _x( '<i class="fa-solid fa-chevron-left"></i>', 'previous set of posts', 'voyager' ),
				'next_text'          => _x( '<i class="fa-solid fa-chevron-right"></i>', 'next set of posts', 'voyager' ),
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'voyager' ),
			)
		);
